...
同时开发两个平台，无论是成本上，还是时间，对于中小企业来说这个花费都是巨大，不可接受的。

纯原生开发的效率，严重影响了应用快速的迭代。迭代慢，部属慢，新版本必须重新下载应用。

不利于多个平台版本控制等。

总结：时间长、成本高、迭代慢、部署慢、不利于推广等因素
...
| 支持平台 | Android、IOS、Windows、MacOS | Android、IOS、Windows | Android、IOS、Web         | Android、IOS、Web     | Android、IOS、Web、小程序、快应用 | Android、IOS、Windows、MacOS、Web、Linux、Fuchsia |
