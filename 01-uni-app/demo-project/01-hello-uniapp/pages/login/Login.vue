	...
	<view class="login">
		<uni-forms ref="formRef" :model-value="formData" :rules="formRules">
			...
			<uni-forms-item label="帐号" name="username" required>
				<uni-easyinput type="text" v-model="formData.username" placeholder="请输入帐号"></uni-easyinput>
			</uni-forms-item>
			
			<!-- 表单项：密码 -->
			<uni-forms-item label="密码" name="password" required>
				<uni-easyinput type="password" v-model="formData.password" placeholder="请输入面膜"></uni-easyinput>
			</uni-forms-item>
		</uni-forms>
